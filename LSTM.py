...
from procesarMidi import generar_cancion,cargarPista,crear_secuencias,getTempo
...
if __name__ == "__main__":
    ...
    l_s = 20
    c_a = "Audios/"
    cancion_a_continuar = "Audios/appass_1.mid"
    ...
    lstm_p_r,rf_velocity_r,rf_duration_r = inicializar_modelo(c_a,l_s, mapa_right, nombre_pista1)
    lstm_p_l,rf_velocity_l,rf_duration_l= inicializar_modelo(c_a,l_s, mapa_left, nombre_pista2)
    
    
    # p_conprediccion_r, v_conprediccion_r, d_conprediccion_r = predecir_cancion(lstm_p_r, rf_velocity_r, rf_duration_r, l_s, mapa_right, cancion_a_continuar, nombre_pista1, cant_predicciones)
    # p_conprediccion_l, v_conprediccion_l, d_conprediccion_l = predecir_cancion(lstm_p_l, rf_velocity_l, rf_duration_l, l_s, mapa_left, cancion_a_continuar, nombre_pista2, cant_predicciones)
    ...
    # cancion_generada.write('midi', fp='cancion_generada_lstm2_appass_1.mid')
